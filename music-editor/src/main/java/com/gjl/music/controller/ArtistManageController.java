...
import com.gjl.music.module.enrich.provider.ArtistInfo;
import com.gjl.music.service.ArtistManageService;
...
public class ArtistManageController {
    ...
    public ResponseEntity<?> applyArtist(@PathVariable Long id,
        ...
        try {
            ...
            if (!info.hasData()) {
                                musicMapper.updateArtist(id, artist.getArtistName(),
