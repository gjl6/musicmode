  ...
  <table class="clay-table">
    <thead>
      <tr>
        <th class="col-idx">#</th>
        <th class="col-cv"></th>
        <th class="col-main">{{ t('genre.cols.name') }}</th>
        <th class="col-num">{{ t('genre.cols.songCount') }}</th>
        <th class="col-act"></th>
      </tr>
    </thead>
    <tbody>
      <tr
        v-for="(row, idx) in genres"
        :key="row.genre"
        class="clay-row"
        @dblclick="$emit('click', row.genre)"
      >
        ...
        <td class="col-main">
          <span class="main-name link" @click="$emit('click', row.genre)">{{ row.genre || '—' }}</span>
        </td>
